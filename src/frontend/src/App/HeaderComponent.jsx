...
const HeaderComponent = (props) => {
    ...
    return (
        <div style={{backgroundColor: "rgb(48, 0, 111)", color: "white", padding: "10px" }}>
            <Image src={CotivitiLogo} alt="Cotiviti" style={{height: 36}} />
            &nbsp;
            &nbsp;
            &nbsp;
            &nbsp;
            ...
            {/* <Header content='Business Process Automation Accelerator' className="header" style={{ fontSize: "24px", color: "white", backgroundColor: "rgb(0, 120, 212)" }} /> */}
            </div>
